...
export const APP_GUIDES: AppGuide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Written now (32 lessons): Noun (What is a noun?, Countable or uncountable?, Noun mistakes to stop making, Nouns in IELTS), Verb (What is a verb?, Main and helping verbs, Verb forms, Common verb mistakes, Verbs in IELTS), Adjective (What is an adjective?, Comparing things, -ed or -ing?, Adjectives in IELTS), Adverb (What is an adverb?, Adjective or adverb?, Where adverbs go, Adverbs in IELTS), Word Forms (The gap tells you the form, Endings that show the job, Word families, Opposites with prefixes, Word forms in IELTS), Pronoun (What pronouns do, Possessives and -self, What does "it" refer to?), Preposition (What prepositions do, Words that need a partner, Prepositions for data), Conjunction (Joining words; because, although, while, if; although, however, despite), Interjection (Oh, well, wow). Parts of Speech in IELTS, Common Mistakes Lab and Final Mastery Challenge show "Soon"; never say they are available.',
